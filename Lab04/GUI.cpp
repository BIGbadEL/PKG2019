///////////////////////////////////////////////////////////////////////////
// C++ code generated with wxFormBuilder (version Mar 26 2019)
...
MyFrame1::MyFrame1(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size,
    ...
    WxRB_Middle = new wxRadioButton(this, wxID_ANY, _("RadioBtn"), wxPoint(-1, -1), wxDefaultSize, 0);
    WxRB_Middle->SetValue(true);
    WxRB_Middle->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW));
    ...
    m_staticText11 = new wxStaticText(this, wxID_ANY, _("Wartou015Bci na wykresie:"), wxDefaultPosition, wxDefaultSize,
                                      0);
